...
//         </div>
//         <Link to="/member/reports/new" className="rounded-2xl bg-cyan-500 px-4 py-3 font-semibold text-slate-950 transition hover:bg-cyan-400">New report</Link>
//       </div>

//       {error && <div className="mt-6 rounded-2xl border border-rose-500/30 bg-rose-500/10 px-4 py-3 text-sm text-rose-300">{error}</div>}

//       {loading ? (
//         <div className="mt-8 rounded-3xl border border-slate-800 bg-slate-900/70 p-10 text-center text-slate-300">Loading your reports...</div>
//       ) : (
//         <div className="mt-8 space-y-6">
//           <div className="grid gap-4 xl:grid-cols-2">
//             {reports.map((report) => (
//               <ReportCard key={report.id} report={report} onEdit={() => navigate(`/member/reports/${report.id}/edit`)} onSubmit={handleSubmit} />
//             ))}
//           </div>
